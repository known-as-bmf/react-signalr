import { HubConnectionBuilder, IHttpConnectionOptions, HubConnection } from '@aspnet/signalr';
 ...
 */
export const createConnection = (url: string, options: IHttpConnectionOptions = {}): HubConnection =>
